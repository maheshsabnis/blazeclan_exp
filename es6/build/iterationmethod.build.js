...
var names = ["Mahesh", "Tejas", "Ramesh", "Pushkar", "Leena", "Neeta", "Neema", "Ajay", "Ram", "Nandu", "Anil", "Keshav", "Abhay", "Jaywant", "Anil", "Shyam", "Shweta"]; // Iteratr over the array
...
function printValues(n, i) {
  console.log("Value at index ".concat(i, " is = ").concat(n));
} // passing function as input parameter to other function


names.forEach(printValues); // Simplyfy the syntax by passing implementation to a method
