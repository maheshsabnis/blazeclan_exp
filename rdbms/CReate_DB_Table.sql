...
-- the DeptNo mentioned in the Insert query must be present into the Department Table as DempNo Primary Key Value
insert into employee Value (121, 'Mahesh', 'Director', 123333, 60);

-- Using Unique Key and Identity Key (Auto-Increament)
-- Defining the Auto_Inctreament Key as Parimary Key  
CReate Table Users(
