...
class EmployeeFormValidationComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      EmpNo: 0,
      ...
      employees: [],
      columnHeaders: [],
      isEmpNoValid:true,  // properties for validation
      isEmpNameValid:true, // properties for validation
      isFormValid:true // properties for validation
    };
      ...
      <div className="container">
        ...
        <form>
          <div className="form-group">
            ...
            <div className="alert alert-danger"
             hidden={this.state.isEmpNoValid}>
               EmpNo is Invalid. Make sure that the value is +v and length is less than 5
             </div>
          </div>
          <div className="form-group">
            ...
            />
             ...
             hidden={this.state.isEmpNameValid}>
               EmpName is Invalid. Make sure that the value is is mandatory and lessthan 20 Characters
             </div>
          </div>
          <div className="form-group">
          ...
          <div className="form-group  btn-group">
            ...
            <input
              type="button"
              value="Save" disabled={!this.state.isFormValid}
